# Домашнее задание к занятию "`Конфигурация приложений`" - `Бакулев Евгений`

## Задание 1. Создать Deployment приложения и решить возникшую проблему с помощью ConfigMap. Добавить веб-страницу

- [Манифест Deployment](https://github.com/garrkiss/storagek8s-2/blob/main/manifest/task1/deployment.yaml)
- [Манифест Configmap для решения проблемы ](https://github.com/garrkiss/storagek8s-2/blob/main/manifest/task1/deployment.yaml)
- [Манифест Configmap html site](https://github.com/garrkiss/storagek8s-2/blob/main/manifest/task1/pv.yaml)
- [Манифест SVC nginx](https://github.com/garrkiss/storagek8s-2/blob/main/manifest/task1/pvc.yaml)
